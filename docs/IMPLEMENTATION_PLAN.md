...
- 桌面图标变成可动画的图标演员。
- 至少两个图标长出白色手脚并开始互动。
- 先能看到可信的长手脚、走路、转身，再进入拳击、转身侧踢、闪避、受击。
...
目标：实现第一版 Icon Fight 的可读动作。动作系统的顺序是先把“像人一样走路”打稳，再叠加拳击、侧踢和受击。走路如果不像人，战斗动作会显得只是图标旁边几根线在摆。
